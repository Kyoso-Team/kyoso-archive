...
//   let qPurchases = db
//     .select({
//       ...pick(dbPurchase, ['id', 'purchasedAt', 'cost', 'payPalOrderId', 'services']),
//       purchasedBy: pick(dbUser, ['id', 'osuUsername', 'osuUserId']),
//       forTournament: pick(dbTournament, ['id', 'name', 'acronym'])
//     })
//     .from(dbPurchase)
//     .where(where)
