...
//     await db
//       .select(pick(dbBeatmap, ['osuBeatmapId']))
//       .from(dbBeatmap)
...
//               }
//             })
//             .returning(pick(dbMapper, ['osuUserId'])),
//           'mapper'
//         );

//         let selectBeatmapset = pick(dbBeatmapset, ['osuBeatmapsetId']);
...
//             })
//             .returning(pick(dbBeatmap, ['osuBeatmapId'])),
//           'beatmap'
//         );
//       });
