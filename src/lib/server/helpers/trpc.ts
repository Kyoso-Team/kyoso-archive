...
export async function getStaffMember<T extends boolean>(session: AuthSession | undefined, tournamentId: number, mustBeStaffMember?: T) {
  return baseGetStaffMember<T>(session, tournamentId, true, {
