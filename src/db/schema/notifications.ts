...
//     .primaryKey()
//     .references(() => dbNotification.id, actions('cascade')),
//   hostedById: integer('hosted_by_id').references(() => User.id)
// });
...
//   previousHostId: integer('previous_host_id').references(() => User.id),
//   newHostId: integer('new_host_id').references(() => User.id)
// });
...
//   affectedUserId: integer('affected_user_id').references(() => User.id),
//   kickedById: integer('kicked_by_id').references(() => User.id)
// });
